...
public class TextMenuTest {
	...
	void testAddDecoration() {
		...
		Template[] result = {
				new LongDecoration("NAME", Usage.OUTSIDE_DECORATION, 123, new TypedLinkedList<>(new String(),Arrays.asList("blue", "red")),
	...
	void testEditDecoration() {
		...
		Template[] result = {
				new LongDecoration("NAME", Usage.OUTSIDE_DECORATION, 123, new TypedArrayList<>(new String(),Arrays.asList("blue", "red")),
						"clossic", "wood", 12, 10, 12.5f),
				new ElectricDecoration("NNAME", Usage.FOR_CHRISTMASS, "plastic", 321,
