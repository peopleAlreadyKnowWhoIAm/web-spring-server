...
public class TextMenuTest {
	...
	void init() {
		decorations = new ArrayList<>(Arrays.asList(
				...
				new ElectricDecoration("Interested house ilumination", Usage.OUTSIDE_DECORATION,
						"plastic", 40,
						new ArrayList<>(Arrays.asList("yellow", "green", "red", "blue",
								"white")),
						2500, 15, 150,
						1200.0f),
				...
				new LongDecoration("Beautiful dawn", Usage.FOR_CHRISTMASS, 350,
						new ArrayList<>(Arrays.asList("yellow", "orange", "white")),
	...
	void testAddDecoration() {
		...
		Template[] result = {
				new LongDecoration("NAME", Usage.OUTSIDE_DECORATION, 123, Arrays.asList("blue", "red"),
						"clossic", "wood", 12, 10, 12.5f),
				new ElectricDecoration("NNAME", Usage.FOR_CHRISTMASS, "plastic", 321,
						Arrays.asList("red", "ble"), 200, 22, 50, 221.5f)
		};
