...
public class LongDecorationTest {
    ...
    void testToString(){
        samples.forEach((a) -> {
            ...
            Assertions.assertTrue(tmp.contains(a.getStyle()), String.format("Error in style %d dec", samples.indexOf(a)));
            Assertions.assertTrue(tmp.contains(String.valueOf(a.getMinimalLength())), String.format("Error in minimal length %d dec", samples.indexOf(a)));
            Assertions.assertTrue(tmp.contains(String.valueOf(a.getWidthInCentimeters())), String.format("Error in width %d dec", samples.indexOf(a)));
