package ua.lpnu.students.labs.laba2.ChristmassDecoration.main;
...
class Main {
    public static void main(String... args) {
        ...
        List<Template> decor = Arrays.asList(
            ...
            new ElectricDecoration("On window net", Usage.FOR_WINDOWS, "plastic", 99, Arrays.asList("yellow"), 120, 30, 20, 120.0f),
            new ElectricDecoration("Patriotical ilumiation", Usage.UNIVERSAL, "plastic", 200, Arrays.asList("yellow", "blue"), 300, 20, 5, 80.0f),
            ...
            new LongDecoration("Mystery night", Usage.OUTSIDE_DECORATION, 120, Arrays.asList("gray", "black", "white"), "wide strip decorated with simple colors", "plastic", 120, 12, 34.6f),

            new OrganicDecoration("Christmass", Usage.UNIVERSAL, 73, "dark green", "classic christmass", "orginic", new Size(100, 200, 100), 507.0f, 60, (new GregorianCalendar(2021, 12, 30)).getTime()),
            new OrganicDecoration("Christmass branches", Usage.UNIVERSAL, 38, "dark green", "classic christmass", "orginic", new Size(10, 100, 50), 50.0f, 60, (new GregorianCalendar(2021, 12, 28)).getTime()),

            new PieceDecoration("Colorful ball", Usage.FOR_CHRISTMASS, 340, "green and blue", "classic", "glass", new Size(10, 10, 10), 65.0f),
            new PieceDecoration("Glass cone", Usage.FOR_CHRISTMASS, 180, "gold-yellow", "classic", "plastic", new Size(8, 15, 8), 25.0f),
            new PieceDecoration("Black cube", Usage.FOR_CHRISTMASS, 20, "black", "modern", "glass", new Size(11, 18, 9), 659.0f),
            new PieceDecoration("Detailed landscape", Usage.FOR_CHRISTMASS, 90, "differnt", "hi-tech", "glass and plactic", new Size(20, 18, 12), 129.0f)
        );

        TextMenu menu = new TextMenu(decor);
        menu.mainMenu();
    }
